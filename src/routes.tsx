...
const BookList = Loadable(lazy(() => import("./pages/book/BookList")));
const AddNewBook = Loadable(lazy(() => import("./pages/book/AddNewBook")));

// News

const NewsList = Loadable(lazy(() => import("./pages/news/NewsList")));
const AddNewList = Loadable(lazy(() => import("./pages/news/AddNewNews")));
